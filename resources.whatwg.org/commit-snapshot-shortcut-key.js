...
// `<a href="https://{my-spec}.spec.whatwg.org/commit-snapshots/{commit-sha}" id="commit-snapshot-link" title="You can also press the 'y' key">Snapshot as of this commit</a>`.
//
